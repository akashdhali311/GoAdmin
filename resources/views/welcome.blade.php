	...
	<div id="canvas">
        <div id="box_wrapper">
                ...
                <div class="flexslider" data-nav="true" data-dots="false">
                    <ul class="slides">
                        ...
                        <li class="ds text-center slide2">
                            <span class="flexslider-overlay"></span>
                            <img src="{{asset('backend')}}/images/slide_02.jpg" alt="">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 itro_slider">
                                        <div class="intro_layers_wrapper">
                        ...
                        <li class="ds text-center slide3">
                            <img src="{{asset('backend')}}/images/slide_03.jpg" alt="">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 itro_slider">
                                        <div class="intro_layers_wrapper">
                        ...
                        <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                            <div class="main-content text-center">
                                <div class="img-wrap text-center">
                                    <img src="{{asset('backend')}}/img/vertical_line.png" alt="">
                ...
                <div class="container">
                    <div class="row c-mb-50 c-mb-md-60">
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="vertical-item text-center">
                                <div class="item-media">
                                    <img src="{{asset('backend')}}/images/service/service_icon_1-1.png" alt="">
                                </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="vertical-item text-center">
                                <div class="item-media">
                                    <img src="{{asset('backend')}}/images/service/service_icon_2-1.png" alt="">
                                </div>
                                <div class="item-content">
                                    <h6>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="vertical-item text-center">
                                <div class="item-media">
                                    <img src="{{asset('backend')}}/images/service/service_icon_3-1.png" alt="">
                                </div>
                                <div class="item-content">
                                    <h6>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="vertical-item text-center">
                                <div class="item-media">
                                    <img src="{{asset('backend')}}/images/service/service_icon_4-1.png" alt="">
                                </div>
                                <div class="item-content">
                                    <h6>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="vertical-item text-center">
                                <div class="item-media">
                                    <img src="{{asset('backend')}}/images/service/service_icon_5-1.png" alt="">
                                </div>
                                <div class="item-content">
                                    <h6>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="vertical-item text-center">
                                <div class="item-media">
                                    <img src="{{asset('backend')}}/images/service/service_icon_6-1.png" alt="">
                                </div>
                                <div class="item-content">
                                    <h6>
                    ...
                    <div class="pink-line text-center">
                        <img src="{{asset('backend')}}/img/pink_line_big.png" alt="">
                    </div>
                </div>
            </section> 
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center c-mb-20 c-mb-lg-60">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="step-center-part text-center">
                                <img src="{{asset('backend')}}/images/step_img_1.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                    ...
                    <div class="row align-items-center right c-mb-20 c-mb-lg-60">
                        ...
                        <div class="col-12 col-lg-4 order-lg-2">
                            <div class="step-center-part text-center">
                                <img src="{{asset('backend')}}/images/step_img_2.jpg" alt="">
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center c-mb-20 c-mb-lg-60">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="step-center-part text-center">
                                <img src="{{asset('backend')}}/images/step_img_3.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="step-right-part">
                    ...
                    <div class="divider-10 d-block d-sm-none"></div>
                    <div class="img-wrap text-center">
                        <img src="{{asset('backend')}}/img/vertical_line2.png" alt="">
                    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="owl-carousel gallery-owl-nav" data-autoplay="false" data-responsive-lg="5" data-responsive-md="3" data-responsive-sm="3" data-responsive-xs="2" data-nav="true" data-dots="false" data-filters=".gallery-filters" data-margin="0" data-loop="true">
                                <div class="vertical-item item-gallery content-absolute text-center ds web-design">
                                    <div class="item-media">
                                        <img src="{{asset('backend')}}/images/gallery/gallery-1.jpg" alt="">
                                ...
                                <div class="vertical-item item-gallery content-absolute text-center ds logo-design">
                                    <div class="item-media">
                                        <img src="{{asset('backend')}}/images/gallery/gallery-2.jpg" alt="">
                                        <div class="media-links">
                                ...
                                <div class="vertical-item item-gallery content-absolute text-center ds advertisement">
                                    <div class="item-media">
                                        <img src="{{asset('backend')}}/images/gallery/gallery-3.jpg" alt="">
                                        <div class="media-links">
                                ...
                                <div class="vertical-item item-gallery content-absolute text-center ds branding">
                                    <div class="item-media">
                                        <img src="{{asset('backend')}}/images/gallery/gallery-4.jpg" alt="">
                                        <div class="media-links">
                                ...
                                <div class="vertical-item item-gallery content-absolute text-center ds design">
                                    <div class="item-media">
                                        <img src="{{asset('backend')}}/images/gallery/gallery-5.jpg" alt="">
                                        <div class="media-links">
                                ...
                                <div class="vertical-item item-gallery content-absolute text-center ds photo">
                                    <div class="item-media">
                                        <img src="{{asset('backend')}}/images/gallery/gallery-6.jpg" alt="">
                                        <div class="media-links">
                    ...
                    <div class="row">
                        <div class="shortcode-team-slider main-team">
                            ...
                            <div class="flexslider team-slider" data-nav="false" data-dots="true">
                                <ul class="slides">
                                    <li class="ls">
                                        <img src="{{asset('backend')}}/images/team/team_slide_01.jpg" alt="">
                                    </li>
                                    <li class="ls">
                                        <img src="{{asset('backend')}}/images/team/team_slide_02.jpg" alt="">
                                    </li>
                                    <li class="ls">
                                        <img src="{{asset('backend')}}/images/team/team_slide_03.jpg" alt="">
                                    </li>
                                    <li class="ls">
                                        <img src="{{asset('backend')}}/images/team/team_slide_04.jpg" alt="">
                                    </li>
                                </ul>
                            </div>
                            <!-- eof flexslider -->
                        ...
                        <div class="row c-gutter-30 c-mb-30 c-mb-lg-0 text-center book">
                            <div class="col-12 col-lg-4">
                                <div class="stage book-1 ls">
                                    <img src="{{asset('backend')}}/images/book-1.png" alt="#">
                                    <div class="info">
                                        <header>
                                            <h6>
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="stage book-2 ds">
                                    <img src="{{asset('backend')}}/images/book-2.png" alt="#">
                                    <div class="info">
                                        <header>
                                            <h6>
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="stage book-3 ls">
                                    <img src="{{asset('backend')}}/images/book-3.png" alt="#">
                                    <div class="info">
                                        <header>
                                            <h6>
                                ...
                                <article class="box text-center">
                                    <div class="item-content">
                                        ...
                                        <div class="post-author">
                                            <img src="{{asset('backend')}}/images/small_author.png" alt="">
                                            <p>
                                                <a href="#">by Admin</a>
                                            </p>
                                        </div>
                            ...
                            <div class="owl-carousel" data-autoplay="false" data-responsive-lg="1" data-responsive-md="1" data-responsive-sm="1" data-nav="false" data-dots="true" id="quote">
                                <div class="quote-item">
                                    <div class="quote-image">
                                        <img src="{{asset('backend')}}/images/team/testimonials_02.jpg" alt="">
                                    </div>
                                ...
                                <div class="quote-item">
                                    <div class="quote-image">
                                        <img src="{{asset('backend')}}/images/team/testimonials_01.jpg" alt="">
                                    </div>
                                    <p class="small-text author-job">
                                        Moving co
                                    </p>
                                ...
                                <div class="quote-item">
                                    <div class="quote-image">
                                        <img src="{{asset('backend')}}/images/team/testimonials_03.jpg" alt="">
                                    </div>
                                    <p class="small-text author-job">
                                        Paradox Inc
                                    </p>
            ...
            <section class="s-pt-50 s-pb-100 s-pt-lg-30 s-pb-lg-75 ls ms teaser-contact-icon main-icon s-parallax" id="contact">
                ...
                <div class="text-center img-wrap col-md-12">
                    <img src="{{asset('backend')}}/img/dark_line_short.png" alt="">
                </div>
                <div class="container">
                    <div class="divider-10 d-none d-xl-block"></div>
                    <div class="row c-mb-50 c-mb-lg-0">
                        <div class="col-lg-4 text-center">
                            <div class="border-icon">
                                <div class="teaser-icon">
                                    <img src="{{asset('backend')}}/images/icon1.png" alt="">
                                </div>
                            </div>
                            <h6>
                                Call Us
                        ...
                        <div class="col-lg-4 text-center">
                            <div class="border-icon">
                                <div class="teaser-icon">
                                    <img src="{{asset('backend')}}/images/icon3.png" alt="">
                                </div>
                            </div>
                            <h6>
                                Write Us
                        ...
                        <div class="col-lg-4 text-center">
                            <div class="border-icon">
                                <div class="teaser-icon">
                                    <img src="{{asset('backend')}}/images/icon2.png" alt="">
                                </div>
                            </div>
                            <h6>
                                Visit Us
