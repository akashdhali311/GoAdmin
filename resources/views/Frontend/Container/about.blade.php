...
@section('content')
				...
				<div class="container">
					<div class="row c-mt-50 c-mt-lg-0">
						<div class="col-lg-4 text-center call-icon">
							<div class="border-icon">
								<div class="teaser-icon">
									<img src="{{asset('backend')}}/images/icon1_about.png" alt="">
								</div>
							</div>
							<h6>
								Who We Are
						...
						<div class="col-lg-4 text-center write-icon">
							...
							<div class="border-icon">
								<div class="teaser-icon">
									<img src="{{asset('backend')}}/images/icon2_about.png" alt="">
								</div>
							</div>
							<div class="icon-content">
								<h6>
						...
						<div class="col-lg-4 text-center visit-icon">
							<div class="border-icon">
								<div class="teaser-icon">
									<img src="{{asset('backend')}}/images/icon3_about.png" alt="">
								</div>
							</div>
							<div class="icon-content">
								<h6>
			...
			<section class="about-map ms page_map" data-draggable="false" data-scrollwheel="false">
				...
				<div class="marker">
						...
						<ul class="list-unstyled">
							...
							<li>
								<span class="icon-inline">
									...
									<span>
										<a href="https://html.modernwebtemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e2a68d96a1908783968b9487a2879a838f928e87cc818d8f">[email&#160;protected]</a>
									</span>
								</span>
							</li>
						</ul>
					...
					<img class="marker-icon" src="{{asset('backend')}}/images/map_marker_icon.png" alt="">
				</div>
				<!-- .marker -->
